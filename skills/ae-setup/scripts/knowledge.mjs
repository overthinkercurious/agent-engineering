...
//
// This is the deterministic half of stage 3. Everything it writes is a fact
// already present in analysis.json, so none of it can be hallucinated. The
...
const OUT = arg('--out', join(ROOT, '.dev', 'knowledge'))
...
if (!QUIET) {
  ...
  process.stdout.write('Facts above the slots came from analysis.json and are safe to trust.\n\n')
}
